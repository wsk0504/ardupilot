...
/*                 _servo4_out = constrain_float(_servo4_out, -0.8f, 1.0f);
                ...
                if (rc().get_pwm(4, rc4_in)) {
                rc_write_angle(AP_MOTORS_MOT_6,  rc4_in*6.452-9648);
                rc_write_angle(AP_MOTORS_MOT_7,  rc4_in*6.452-9648);
                rc_write_angle(AP_MOTORS_MOT_9,  rc4_in*6.452-9648);
                rc_write_angle(AP_MOTORS_MOT_10, rc4_in*6.452-9648);
                }
            }
            //
            if (_tail_type == AP_MOTORS_HELI_SINGLE_TAILTYPE_DIRECTDRIVE_FIXEDPITCH_CW || _tail_type == AP_MOTORS_HELI_SINGLE_TAILTYPE_DIRECTDRIVE_FIXEDPITCH_CCW){
